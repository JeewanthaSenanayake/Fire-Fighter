            ...
            <v-card style="background-color: #424242; border-radius: 15px;" class="pa-2">
                ...
                <v-row class="mt-4 pb-3">
                    <v-col cols="7" class="ml-4 mr-4">
                        <v-card style="border-radius: 15px; background-color: #616161;">
                            <v-row class="mt-3 pl-7 mb-1">
                                <h3 style="color: white; background-color: #76FF03; border-radius: 10px;"
                                    class="px-2 py-1">
                                    No any fire alert</h3>
                            </v-row>
                            <div>
                                <MapComponent />
                            </div>
                    ...
                    <v-col cols="4" class="ml-4">
                        <v-card style="border-radius: 15px; background-color: #616161;">
                            <v-row style="color: white;" class="mt-3 mr-4 ml-4 mb-1 d-flex justify-space-between align-center">
                                Fire History
